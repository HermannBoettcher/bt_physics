      ...
      \begin{tikzpicture}
          ...
          \begin{axis}[
            ...
            every axis plot,
  					...
  					\addlegendentry{$LF_\mathrm{cond}^\mathrm{295f''}$}
  					\addplot[mark=none, color=red!50] table [x=r_kelvin,y=liquid_fraction]{tikz/graphs/295_e_f_ALD/295f200ALD_evap_1.txt};
  					\addlegendentry{$LF_\mathrm{evap}^\mathrm{295f''}$}
          \end{axis}
          \begin{axis}[
            /tikz/line join=bevel,
            ...
            ymajorgrids=true,
  					...
  					% Add plots
  					\addplot[mark=none, color=red] table [x=r_kelvin,y=transmission]{tikz/graphs/295_e_f_ALD/295f200ALD_cond_1.txt};
  					\addlegendentry{$T_\mathrm{cond}^\mathrm{295f''}$}
  					\addplot[mark=none, color=red!50] table [x=r_kelvin,y=transmission]{tikz/graphs/295_e_f_ALD/295f200ALD_evap_1.txt};
  					\addlegendentry{$T_\mathrm{evap}^\mathrm{295f''}$}
          \end{axis}
      \end{tikzpicture}
