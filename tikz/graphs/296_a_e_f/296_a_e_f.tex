    ...
    \begin{tikzpicture}[
        ...
        \begin{axis}[
          ...
          xtick = {},
					...
					\addlegendentry{$T_{t_\mathrm{fl}=\SI{0}{\minute}}^\mathrm{cond}$}
					\addplot[mark=none, color=blue] table [x=Prel,y=transmission]{tikz/graphs/296_a_e_f/296e_cond_2.txt};
					\addlegendentry{$T_{t_\mathrm{fl}=\SI{13}{\minute}}^\mathrm{cond}$}
					\addplot[mark=none, color=green] table [x=Prel,y=transmission]{tikz/graphs/296_a_e_f/296f_cond_2.txt};
					\addlegendentry{$T_{t_\mathrm{fl}=\SI{26}{\minute}}^\mathrm{cond}$}
					\addplot[mark=none, color=red!50] table [x=Prel,y=transmission]{tikz/graphs/296_a_e_f/296a_evap_2.txt};
					%\addlegendentry{$T_{t_\mathrm{fl}=\SI{0}{\minute}}^\mathrm{evap}$}
					\addplot[mark=none, color=blue!50] table [x=Prel,y=transmission]{tikz/graphs/296_a_e_f/296a_evap_2.txt};
					%\addlegendentry{$T_{t_\mathrm{fl}=\SI{13}{\minute}}^\mathrm{evap}$}
					\addplot[mark=none, color=green!50] table [x=Prel,y=transmission]{tikz/graphs/296_a_e_f/296f_evap_2.txt};
					%\addlegendentry{$T_{t_\mathrm{fl}=\SI{26}{\minute}}^\mathrm{evap}$}
        \end{axis}
    \end{tikzpicture}
