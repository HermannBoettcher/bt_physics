...
\begin{document}
  \begin{figure}[htpb]
    ...
    \caption{Comparison of closed pore membranes \protect\subref{fig:295-296-funnelling-cp} and open pore membranes \protect\subref{fig:295-296-funnelling-op} of different thickness. The membranes of wafer 295 are $l_\mathrm{pore}=\SI{30}{\micro\meter}$ thick, wheras the membranes of the wwafers 292 and 296 are $l_\mathrm{pore}=\SI{60}{\micro\meter}$ thick. For interpretations please refer to \cref{sec:thinner-membranes}.}
