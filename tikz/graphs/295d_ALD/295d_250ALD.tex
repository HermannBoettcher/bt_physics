    ...
    \begin{tikzpicture}
        ...
        \begin{axis}[
          ...
          every axis plot,
					...
					\addplot[mark=none, color=red!50] table [x=Prel,y=liquid_fraction]{tikz/graphs/295d_ALD/295d250ALD_evap_1.txt};
        ...
        \end{axis}
          ...
          legend style={at={(0,0.5)}, legend columns=1, anchor=south west},
					...
					\addplot[mark=none, color=red!50] table [x=Prel,y=transmission]{tikz/graphs/295d_ALD/295d250ALD_evap_1.txt};
