    ...
    \tikzsetnextfilename{example_isotherm}
          \begin{tikzpicture}
            ...
            \begin{axis}[
              ...
              % Add plots
              \addplot[mark=none, color=blue] table [x=Prel,y=mol]{tikz/graphs/295d_integration_visualization/296b_op_cond_1.txt};
              \addlegendentry{condensation}
              \addplot[mark=none, color=blue!50] table [x=Prel,y=mol]{tikz/graphs/295d_integration_visualization/296b_op_evap_1.txt};
