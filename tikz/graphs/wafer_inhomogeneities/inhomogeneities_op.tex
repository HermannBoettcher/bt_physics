...
\begin{document}
  \begin{figure}
    ...
    \caption{Comparison of open pore membranes of one wafer. \protect\subref{fig:292-op} compares membranes of wafer 292 while \protect\cref{fig:295-op} deals with 295.}
  \end{figure}
\end{document}
