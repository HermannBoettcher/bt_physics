    ...
    \begin{tikzpicture}
        ...
        \begin{axis}[
          ...
          every axis plot,
					...
					% Add plots
					\addplot[mark=none, color=blue] table [x=Prel,y=liquid_fraction]{tikz/graphs/295a/295a_evap_4.txt};
        ...
        \end{axis}
          ...
          legend style={at={(0,0.5)}, legend columns=1, anchor=south west},
					...
					% Add plots
					\addplot[mark=none, color=red] table [x=Prel,y=transmission]{tikz/graphs/295a/295a_evap_4.txt};
