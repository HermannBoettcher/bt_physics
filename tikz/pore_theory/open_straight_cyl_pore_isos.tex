...
\begin{figure}[p]
    ...
    \caption{Condensation \protect\subref{fig:open-straight-op} and evaporation \protect\subref{fig:open-straight-op-evap} isotherm of an open straight pore. The corresponding processes inside the pore are illustrated below the isotherm itself. Colors of the arrows between pore states and the respecting pressure range of the graph match.}
