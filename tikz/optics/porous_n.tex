...
\begin{figure}[tb]
    ...
    \end{tikzpicture}
    \caption{Illustration of the idea behind the effective medium approximation applied on the refractive index of a porous medium (compare \cref{subsec:effective-medium-approx}).}
