...
\begin{figure}[ht]
    ...
    \subfloat[]{
      \tikzsetnextfilename{aluminum_dissolution}
      \begin{tikzpicture}
    ...
    \end{tikzpicture}
    \label{fig:float}}
    \caption{\protect\subref{fig:al-dissolution-setup} shows the setup for the aluminum dissolution step. The wafer is immersed in acid composed according to \cref{eq:aluminum-dis-acid} which dissolves aluminum. In \protect\subref{fig:float} the \textit{barrier layer} dissolution by floating the membrane on phosphoric acid is illustrated.}
